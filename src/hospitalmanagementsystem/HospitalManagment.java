...
public class HospitalManagment {
    ...
    public static void main(String args[]) {
        ...
        d[0].did = "21";
        d[0].dname = "Dr.Prosenjit";
        d[0].specilist = "Eys spacialist";
        d[0].appoint = "5pm-5pm";
        d[0].doc_qual = "MBBS,MD";
        d[0].droom = 17;
        d[1].did = "32";
        d[1].dname = "Dr.Tahajib";
        ...
        d[2].did = "17";
        d[2].dname = "Dr.Rafiul";
        d[2].specilist = "Cardiology spacialist";
        d[2].appoint = "8-11AM";
        d[2].doc_qual = "BDM";
        d[2].droom = 18;
        d[3].did = "33";
                    ...
                    while (s2 == 1) {
                        ...
                        switch (c1) {
                            ...
                            case 3: {
                                //int flag = 0;
                                String find_name;
                                find_name = input.nextLine();//f=90
                                for (int k = 0; k < p.length; k++) {
                                    if (find_name == p[k].pname) {
                                        System.out.println("--------------------------------------------------------------------------------");
                                        System.out.println("id \t Name \t Disease \t Gender \t Admit Status \t Age");
                                        System.out.println("--------------------------------------------------------------------------------");
                                        // for (j = 0; j < count2; j++) {
                            ...
                            //Detete paient
                            case 4: {
                                System.out.println("Enter the Patient name you want to remove ");
                                String elem = input.nextLine();
                                //1,2,3,4,5,6
                                //4
                                for (i = 0; i < p.length; i++) {
                                    if (p[i].pname == elem) //If element found/    //4
                                    {
                                        // shifting elements
                                ...
                                System.out.println("Patient List  after deletion ");
